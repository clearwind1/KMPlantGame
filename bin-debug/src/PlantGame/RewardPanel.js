...
(function (PlantGame) {
    var RewardPanel = (function (_super) {
        ...
        __egretProto__.showginseng = function (data1, data2) {
            ...
            var yhjCode = GameUtil.createTextField(40, yhjcodepoy, 20, 0, 0.5, egret.HorizontalAlign.LEFT);
            yhjCode.text = "券       码:" + "  " + data2['code'];
            yhjCode.textColor = 0x7d4406;
            this.youhuijuancon.addChild(yhjCode);
            if (getitemtype['itemtype'] != 3) {
                var shopaddress = GameUtil.createTextField(40, 420, 20, 0, 0.5, egret.HorizontalAlign.LEFT);
