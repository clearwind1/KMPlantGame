...
(function (GameUtil) {
    var RadioButton = (function (_super) {
        ...
        __egretProto__.addItem = function (item, pox, poy) {
            this.itemCount++;
        ...
        __egretProto__.chooseButton = function (tag) {
        ...
        __egretProto__.getCurSelectTag = function () {
            return this.curseltTag;
        };
        return RadioButton;
    })(egret.DisplayObjectContainer);
    GameUtil.RadioButton = RadioButton;
    RadioButton.prototype.__class__ = "GameUtil.RadioButton";
})(GameUtil || (GameUtil = {}));
